! function(t, e) {
    ...
    return function() {
                ...
                93379: function(t, e, i) {
                    ...
                    function h(t, e, i) {
                        var s = i.css,
                            a = i.media,
                            n = i.sourceMap;
                        if (a ? t.setAttribute("media", a) : t.removeAttribute("media"), n && "undefined" != typeof btoa && (s += "\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(n)))), " */")), t.styleSheet) t.styleSheet.cssText = s;
                        else {
                    ...
                    function v(t, e) {
                        ...
                        } else i = c(e), s = h.bind(null, i, e), a = function() {
                            ! function(t) {
        ...
        return function() {
            ...
            var d, m = ["rtl", "style", "headerType", "contentLayout", "layoutCollapsed", "showDropdownOnHover", "layoutNavbarOptions", "layoutFooterFixed", "themes"],
                h = ["light", "dark", "system"],
            ...
            var v = document.getElementsByTagName("HTML")[0].getAttribute("data-theme") || 0,
                ...
                w = y.contains("layout-menu-offcanvas") ? "static-offcanvas" : y.contains("layout-menu-fixed") ? "fixed" : y.contains("layout-menu-fixed-offcanvas") ? "fixed-offcanvas" : "static",
                x = function() {
                    function t(e) {
                        var i = e.cssPath,
                            s = e.themesPath,
                        ...
                        if (function(t, e) {
                            ...
                            if (this.settings = {}, this.settings.cssPath = i, this.settings.themesPath = s, this.settings.cssFilenamePattern = a || "%name%.css", this.settings.displayCustomizer = void 0 === n || n, this.settings.controls = o || m, this.settings.defaultTextDir = "rtl" === r || g, this.settings.defaultHeaderType = l || w, this.settings.defaultMenuCollapsed = void 0 !== u ? u : b, this.settings.defaultContentLayout = void 0 !== c ? c : S, this.settings.defaultShowDropdownOnHover = void 0 === d || d, this.settings.defaultNavbarType = void 0 !== y ? y : _, this.settings.defaultFooterFixed = void 0 !== x ? x : z, this.settings.availableDirections = L || t.DIRECTIONS, this.settings.availableStyles = A || t.STYLES, this.settings.availableThemes = O || t.THEMES, this.settings.availableHeaderTypes = I || t.HEADER_TYPES, this.settings.availableContentLayouts = N || t.CONTENT, this.settings.availableLayouts = E || t.LAYOUTS, this.settings.availableNavbarOptions = F || t.NAVBAR_OPTIONS, this.settings.defaultTheme = this._getDefaultTheme(void 0 !== D ? D : v), this.settings.styles = C || h, this.settings.navbarOptions = k || p, this.settings.defaultStyle = T || f, this.settings.lang = M || "en", this.pathResolver = q || function(t) {
                                ...
                                var B = this.settings.controls.indexOf("style"); - 1 !== B && (this.settings.controls = this.settings.controls.slice(0, B).concat(this.settings.controls.slice(B + 1)))
                            }
                    ...
                    return e = t, i = [{
                        ...
                        value: function() {
                            ...
                            if (this._hasControls("rtl headerType contentLayout layoutCollapsed layoutNavbarOptions", !0)) {
                                ...
                                var w = this.container.querySelector(".template-customizer-headerOptions"),
                                    x = document.documentElement.getAttribute("data-template").split("-");
                                if (this._hasControls("headerType")) {
                                    var C = w.querySelector(".template-customizer-header-options");
                                    setTimeout((function() {
                                        x.includes("vertical") && w.parentNode.removeChild(w)
                                ...
                                if (this._hasControls("layoutNavbarOptions")) {
                                    setTimeout((function() {
                                        x.includes("horizontal") && I.parentNode.removeChild(I)
                                    }), 100);
