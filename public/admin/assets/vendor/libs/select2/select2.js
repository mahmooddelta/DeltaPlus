                                        ...
                                        n && n.requirejs || (n ? t = n : n = {}, function(n) {
                                            ...
                                            s = function(e, t) {
                                                var n, i = b(e),
                                                    r = i[0],
                                                    o = t[1];
                                                return e = i[1], r && (n = w(r = m(r, o))), r ? e = n && n.normalize ? n.normalize(e, y(o)) : m(e, o) : (r = (i = b(e = m(e, o)))[0], e = i[1], r && (n = w(r))), {
                                                    f: r ? r + "!" + e : e,
                                                    n: e,
                                                    pr: r,
                                                    p: n
                                                ...
                                                if (m = $(r = r || e), "undefined" === A || "function" === A) {
                                                    for (t = !t.length && i.length ? ["require", "exports", "module"] : t, f = 0; f < t.length; f += 1)
                                                        ...
                                                        else if ("exports" === u) b[f] = a.exports(e), y = !0;
                                                    else if ("module" === u) o = b[f] = a.module(e);
                                                    else if (g(l, u) || g(c, u) || g(d, u)) b[f] = w(u);
                                                    else {
                                                        if (!h.p) throw new Error(e + " missing " + u);
                                                        h.p.load(h.n, v(r, !0), _(u), {}), b[f] = l[u]
                                                    }
                                                    p = i ? i.apply(l[e], b) : void 0, e && (o && o.exports !== n && o.exports !== l[e] ? l[e] = o.exports : p === n && y || (l[e] = p))
                                                } else e && (l[e] = i)
