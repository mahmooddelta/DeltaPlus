        ...
        var t = {
                50840: function(t, e, n) {
                    ...
                    ! function(r, s, o, a) {
                        ...
                        function nt(t, e, n) {
                            ...
                            n.isFirst = !!s, n.isFinal = !!o, s && (t.session = {}), n.eventType = e,
                                function(t, e) {
                                    ...
                                    e.overallVelocityX = c.x, e.overallVelocityY = c.y, e.overallVelocity = f(c.x) > f(c.y) ? c.x : c.y, e.scale = o ? (l = o.pointers, p = i, at(p[0], p[1], tt) / at(l[0], l[1], tt)) : 1, e.rotation = o ? function(t, e) {
                        ...
                        function te(t, e) {
                            var n;
                            this.options = u({}, Qt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = new((n = this).options.inputClass || (Y ? gt : F ? At : X ? Pt : pt))(n, nt), this.touchAction = new Wt(this, this.options.touchAction), ee(this, !0), g(this.options.recognizers, (function(t) {
