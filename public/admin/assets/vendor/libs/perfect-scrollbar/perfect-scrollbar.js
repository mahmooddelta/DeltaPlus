                ...
                45529: function(t) {
                    t.exports = function() {
                        ...
                        function w(t) {
                            ...
                            t.containerWidth = Math.round(i.width), t.containerHeight = Math.round(i.height), t.contentWidth = e.scrollWidth, t.contentHeight = e.scrollHeight, e.contains(t.scrollbarXRail) || (o(e, s.element.rail("x")).forEach((function(t) {
                                return l(t)
                        ...
                        function R(t) {
                            t.element, t.event.bind(t.scrollbarY, "mousedown", (function(t) {
                                ...
                                t.element.scrollTop += r * t.containerHeight, w(t), e.stopPropagation()
                            })), t.event.bind(t.scrollbarX, "mousedown", (function(t) {
                                return t.stopPropagation()
                            })), t.event.bind(t.scrollbarXRail, "mousedown", (function(e) {
                                var r = e.pageX - window.pageXOffset - t.scrollbarXRail.getBoundingClientRect().left > t.scrollbarXLeft ? 1 : -1;
                                t.element.scrollLeft += r * t.containerWidth, w(t), e.stopPropagation()
                            }))
                        }
                        ...
                        function S(t, e) {
                            ...
                            function m(e) {
                                e.touches && e.touches[0] && (e[n] = e.touches[0].pageY), p[u] = b + v * (e[n] - g), c(t, d), w(t), e.stopPropagation(), e.type.startsWith("touch") && e.changedTouches.length > 1 && e.preventDefault()
                            }

                            function Y() {
                                h(t, d), t[f].classList.remove(s.state.clicking), t.event.unbind(t.ownerDocument, "mousemove", m)
                            }

                            function y(e, o) {
                                b = p[u], o && e.touches && (e[n] = e.touches[0].pageY), g = e[n], v = (t[i] - t[r]) / (t[l] - t[a]), o ? t.event.bind(t.ownerDocument, "touchmove", m) : (t.event.bind(t.ownerDocument, "mousemove", m), t.event.once(t.ownerDocument, "mouseup", Y), e.preventDefault()), t[f].classList.add(s.state.clicking), e.stopPropagation()
                            }
                        ...
                        function H(t) {
                            ...
                            t.event.bind(t.ownerDocument, "keydown", (function(n) {
                                if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented) && (r() || i())) {
                                    ...
                                    t.settings.suppressScrollX && 0 !== s || t.settings.suppressScrollY && 0 !== a || (e.scrollTop -= a, e.scrollLeft += s, w(t), l(s, a) && n.preventDefault())
                                }
                            }))
                        }
                        ...
                        function E(e) {
                            ...
                            function o(t) {
                                ...
                                if (!l(t.target, s, a)) {
                                    var c = !1;
                                    e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (a ? r.scrollTop -= a * e.settings.wheelSpeed : r.scrollTop += s * e.settings.wheelSpeed, c = !0) : e.scrollbarXActive && !e.scrollbarYActive && (s ? r.scrollLeft += s * e.settings.wheelSpeed : r.scrollLeft -= a * e.settings.wheelSpeed, c = !0) : (r.scrollTop -= a * e.settings.wheelSpeed, r.scrollLeft += s * e.settings.wheelSpeed), w(e), (c = c || i(s, a)) && !t.ctrlKey && (t.stopPropagation(), t.preventDefault())
                                }
                            }
                        ...
                        function M(e) {
                            if (X.supportsTouch || X.supportsIePointer) {
                                var r = e.element,
                                    ...
                                    l = {},
                                    o = null;
                                X.supportsTouch ? (e.event.bind(r, "touchstart", d), e.event.bind(r, "touchmove", p), e.event.bind(r, "touchend", b)) : X.supportsIePointer && (window.PointerEvent ? (e.event.bind(r, "pointerdown", d), e.event.bind(r, "pointermove", p), e.event.bind(r, "pointerup", b)) : window.MSPointerEvent && (e.event.bind(r, "MSPointerDown", d), e.event.bind(r, "MSPointerMove", p), e.event.bind(r, "MSPointerUp", b)))
                            }
                            ...
                            function c(t, i) {
                                r.scrollTop -= i, r.scrollLeft -= t, w(e)
                            }
                            ...
                            function p(t) {
                                if (u(t)) {
                                    ...
                                    var d = (new Date).getTime(),
                                        p = d - n;
                                    p > 0 && (l.x = o / p, l.y = s / p, n = d), a(o, s) && t.preventDefault()
                                }
                            }

                            function b() {
                                e.settings.swipeEasing && (clearInterval(o), o = setInterval((function() {
                                    e.isInitialized ? clearInterval(o) : l.x || l.y ? Math.abs(l.x) < .01 && Math.abs(l.y) < .01 ? clearInterval(o) : e.element ? (c(30 * l.x, 30 * l.y), l.x *= .8, l.y *= .8) : clearInterval(o) : clearInterval(o)
                                }), 10))
                            }
                        }
                        var x = function() {
                            ...
                            P = function(i, n) {
                                ...
                                for (var o in this.element = i, i.classList.add(s.main), this.settings = x(), n) this.settings[o] = n[o];
                        ...
                        return P.prototype.update = function() {
                            this.isAlive && (this.negativeScrollAdjustment = this.isNegativeScroll ? this.element.scrollWidth - this.element.clientWidth : 0, e(this.scrollbarXRail, {
                                ...
                                display: "none"
                            }), w(this), g(this, "top", 0, !1, !0), g(this, "left", 0, !1, !0), e(this.scrollbarXRail, {
                                display: ""
                            }), e(this.scrollbarYRail, {
                                display: ""
                            }))
