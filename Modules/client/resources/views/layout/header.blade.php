        ...
        <div class="main-bar clearfix">
            <div class="container clearfix">
                ...
                <div class="logo-header mostion logo-dark">
                    <a href="index.html"><img src="http://localhost/vendor/images/logo.png" alt=""></a>
                </div>
                <div class="logo-header mostion logo-white">
                    <a href="index.html"><img src="http://localhost/vendor/images/logo-white.png" alt=""></a>
                </div>
                ...
                <div class="extra-nav">
                    <div class="extra-cell">
                        ...
                        <a href="http://localhost/register" class="site-button"><i class="fa fa-user"></i> Register </a>
                    ...
                    <ul class="nav navbar-nav">
                        <li>
                            ...
                            <ul class="sub-menu left">
                                ...
                                <li><a href="index-3.html" class="dez-page">Home 3 <span class="new-page">New</span></a></li>
                            </ul>
                        </li>
                        <li>
