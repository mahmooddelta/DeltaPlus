                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="dropdown">
                                    <button class="btn p-0" type="button" id="salesOverview"
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="card-body">
                                    <div class="card-info mb-3 py-2 mb-lg-1 mb-xl-3">
                                        ...
                                        <div class="badge bg-label-primary rounded-pill lh-xs">Year of
                                            2021
                                        </div>
                                    </div>
                            ...
                            <div class="col-6 text-end d-flex align-items-end justify-content-center">
                                <div class="card-body pb-0 pt-3 position-absolute bottom-0">
                                    <img
                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/illustrations/card-ratings-illustration.png"
                    ...
                    <div class="card h-100">
                        <div class="row">
                            ...
                            <div class="col-6 text-end d-flex align-items-end justify-content-center">
                                <div class="card-body pb-0 pt-3 position-absolute bottom-0">
                                    <img
                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/illustrations/card-session-illustration.png"
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div
                                            ...
                                            <img
                                                src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/card-weekly-sales-phone.png"
                            ...
                            <div class="swiper-slide">
                                <div class="row">
                                    ...
                                    <div
                                        class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                                        <img
                                            src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/card-weekly-sales-controller.png"
                                            alt="weekly sales" width="230" class="weekly-sales-img">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="row">
                                    ...
                                    <div
                                        class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                                        <img
                                            src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/card-weekly-sales-watch.png"
                                            alt="weekly sales" width="230" class="weekly-sales-img">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="d-flex">
                                            <a href="javascript:void(0)" class="me-3">
                                                <img
                                                    src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/icons/misc/pdf.png"
                                    ...
                                    <div class="table-responsive text-nowrap">
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                <td class="ps-0">
                                                    <img
                                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/samsung-s22.png"
                                                        alt="samsung" class="rounded" height="34">
                                                </td>
                                                <td class="h6 ps-0">Oneplus 9 Pro</td>
                                                <td class="text-heading text-end pe-0"><span
                                                        class="badge rounded-pill bg-label-primary">Out of Stock</span>
                                                </td>
                                                <td class="h6 mb-0 text-end pe-0">$12.5k</td>
                                                <td class="pe-0 text-end fw-medium h6 text-success">+24%
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="ps-0">
                                                    <img
                                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/apple-iPhone-13-pro.png"
                                                        alt="iphone" class="rounded" height="34">
                                                </td>
                                                <td class="h6 ps-0">Apple iPhone 13 Pro</td>
                                                <td class="text-heading text-end pe-0"><span
                                                        class="badge rounded-pill bg-label-success">In Stock</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="ps-0">
                                                    <img
                                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/oneplus-9-pro.png"
                                                        alt="us-flag" class="rounded" height="34">
                                                </td>
                                                <td class="h6 ps-0">Oneplus 9 Pro</td>
                                                <td class="text-heading text-end pe-0"><span
                                                        class="badge rounded-pill bg-label-warning">Coming Soon</span>
                                                </td>
                                                <td class="h6 mb-0 text-end pe-0 text-heading">$98.2k</td>
                                                <td class="pe-0 text-end fw-medium h6 text-success">+55%
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="table-responsive text-nowrap">
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                <td class="ps-0">
                                                    <img
                                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/apple-mac-mini.png"
                                                ...
                                                <td class="pe-0 text-end fw-medium h6 text-success">+16%
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="ps-0">
                                                    <img
                                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/hp-envy-x360.png"
                                                ...
                                                <td class="pe-0 text-end fw-medium h6 text-success">+27%
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="ps-0">
                                                    <img
                                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/dell-inspiron-3000.png"
                                    ...
                                    <div class="table-responsive text-nowrap">
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                <td class="ps-0">
                                                    <img
                                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/sony-play-station-5.png"
                                                ...
                                                <td class="pe-0 text-end fw-medium h6 text-success">+34%
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="ps-0">
                                                    <img
                                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/xbox-series-x.png"
                                            ...
                                            <tr>
                                                <td class="ps-0">
                                                    <img
                                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/nintendo-switch.png"
                                                ...
                                                <td class="pe-0 text-end fw-medium h6 text-success">+38%
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide pb-3">
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <img
                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/card-marketing-expense-logo.png"
                                        ...
                                        <div class="row d-flex flex-wrap justify-content-between">
                                            <div class="col-6">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="d-flex mb-2 pb-1 align-items-center">
                                                        <small
                                                            class="mb-0 me-2 sales-text-bg bg-label-secondary">5k</small>
                                                        <small class="mb-0 text-truncate">Operating</small>
                                                    </li>
                                                    <li class="d-flex align-items-center">
                                                        <small
                                                            class="mb-0 me-2 sales-text-bg bg-label-secondary">6k</small>
                                            ...
                                            <div class="col-6">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="d-flex mb-2 pb-1 align-items-center">
                                                        <small
                                                            class="mb-0 me-2 sales-text-bg bg-label-secondary">2k</small>
                                                        <small class="mb-0 text-truncate">Financial</small>
                                                    </li>
                                                    <li class="d-flex align-items-center">
                                                        <small
                                                            class="mb-0 me-2 sales-text-bg bg-label-secondary">1k</small>
                            ...
                            <div class="swiper-slide pb-3">
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <img
                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/card-accounting-logo.png"
                                        alt="Marketing and sales" width="84" class="rounded">
                                    <div class="d-flex flex-column w-100 ms-4">
                                        ...
                                        <div class="row d-flex flex-wrap justify-content-between">
                                            <div class="col-6">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="d-flex mb-2 pb-1 align-items-center">
                                                        <small
                                                            class="mb-0 me-2 sales-text-bg bg-label-secondary">18</small>
                                                        <small class="mb-0 text-truncate">Billing</small>
                                                    </li>
                                                    <li class="d-flex align-items-center">
                                                        <small
                                                            class="mb-0 me-2 sales-text-bg bg-label-secondary">30</small>
                                            ...
                                            <div class="col-6">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="d-flex mb-2 pb-1 align-items-center">
                                                        <small
                                                            class="mb-0 me-2 sales-text-bg bg-label-secondary">28</small>
                                                        <small class="mb-0 text-truncate">Sales</small>
                                                    </li>
                                                    <li class="d-flex align-items-center">
                                                        <small
                                                            class="mb-0 me-2 sales-text-bg bg-label-secondary">80</small>
                            ...
                            <div class="swiper-slide pb-3">
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <img
                                        src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/products/card-sales-overview-logo.png"
                                        alt="Marketing and sales" width="84" class="rounded">
                                    <div class="d-flex flex-column w-100 ms-4">
                                        ...
                                        <div class="row d-flex flex-wrap justify-content-between">
                                            <div class="col-6">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="d-flex mb-2 pb-1 align-items-center">
                                                        <small
                                                            class="mb-0 me-2 sales-text-bg bg-label-secondary">68</small>
                                                        <small class="mb-0 text-truncate">Open</small>
                                                    </li>
                                                    <li class="d-flex align-items-center">
                                                        <small
                                                            class="mb-0 me-2 sales-text-bg bg-label-secondary">04</small>
                                            ...
                                            <div class="col-6">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="d-flex mb-2 pb-1 align-items-center">
                                                        <small
                                                            class="mb-0 me-2 sales-text-bg bg-label-secondary">52</small>
                                                        <small class="mb-0 text-truncate">Converted</small>
                                                    </li>
                                                    <li class="d-flex align-items-center">
                                                        <small
                                                            class="mb-0 me-2 sales-text-bg bg-label-secondary">12</small>
            ...
            <div class="container-xxl">
                <div
                    ...
                    <div class="mb-2 mb-md-0">
                        ...
                        by <a href="https://pixinvent.com" target="_blank" class="footer-link fw-medium">Pixinvent</a>
                    </div>
