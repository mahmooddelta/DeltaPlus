        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <li class="nav-item dropdown-shortcuts navbar-dropdown dropdown me-1 me-xl-0">
                ...
                <div class="dropdown-menu dropdown-menu-end py-0">
                    ...
                    <i class="mdi mdi-calendar fs-4"></i>
                                ...
                                <a href="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo-3/app/calendar"
                    ...
                    <i class="mdi mdi-file-document-outline fs-4"></i>
                                ...
                                <a href="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo-3/app/invoice/list"
                    ...
                    <i class="mdi mdi-account-outline fs-4"></i>
                                ...
                                <a href="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo-3/app/user/list"
                    ...
                    <i class="mdi mdi-shield-check-outline fs-4"></i>
                                ...
                                <a href="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo-3/app/access-roles"
                    ...
                    <i class="mdi mdi-chart-pie-outline fs-4"></i>
                                ...
                                <a href="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo-3"
                    ...
                    <i class="mdi mdi-cog-outline fs-4"></i>
                                ...
                                <a href="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo-3/pages/account-settings-account"
                    ...
                    <i class="mdi mdi-help-circle-outline fs-4"></i>
                                ...
                                <a href="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo-3/pages/faq"
                    ...
                    <i class="mdi mdi-dock-window fs-4"></i>
                                ...
                                <a href="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo-3/modal-examples"
                            ...
                            <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0">
                                        <div class="avatar me-1">
                                            <img
                                                src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/avatars/9.png"
                                                alt class="w-px-40 h-auto rounded-circle">
                                        </div>
                                    </div>
                                    <div
                            ...
                            <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0">
                                        <div class="avatar me-1">
                                            <img
                                                src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/avatars/5.png"
                                                alt class="w-px-40 h-auto rounded-circle">
                                        </div>
                                    </div>
                                    <div
                            ...
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0">
                                        <div class="avatar me-1">
                                            <img
                                                src="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo/assets/img/avatars/6.png"
                                                alt class="w-px-40 h-auto rounded-circle">
                                        </div>
                                    </div>
                                    <div
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item"
                           href="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo-3/pages/profile-user">
                            <div class="d-flex">
                    ...
                    <li>
                        <a class="dropdown-item"
                           href="https://demos.pixinvent.com/materialize-html-laravel-admin-template/demo-3/pages/account-settings-billing">
